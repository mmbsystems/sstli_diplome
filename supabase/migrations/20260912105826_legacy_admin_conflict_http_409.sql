-- Version mismatches are permanent application conflicts, not retryable serialization failures.
begin;
...
begin
  ...
  if p_action='create' then
    ...
    if not found then raise exception using errcode='PT409', message='Version conflict'; end if;
  else
